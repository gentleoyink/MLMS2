    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fee', djmoney.models.fields.MoneyField(decimal_places=2, default_currency='USD', max_digits=14)),
                ('is_active', models.BooleanField(default=True)),
                ('is_marketplace', models.BooleanField(default=False)),
                ('video_hours', models.DecimalField(decimal_places=2, default=0.0, max_digits=5)),
                ('num_files', models.IntegerField(default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lesson', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='resources', to='modules.lesson')),
            ],
        ),
        migrations.CreateModel(
            name='ModuleRating',
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='module_ratings', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            model_name='lesson',
